...
export default async function SurveysPage() {
  ...
  const surveyItems = await listSurveys(user);
  ...
  return (
    ...
    >
      <div className="toolbar">
        ...
        <label className="compact-field"><span>Status</span><select defaultValue="todos"><option value="todos">Todos</option><option>Ativa</option><option>Rascunho</option><option>Encerrada</option></select></label>
      </div>
